    ...
    class Program
    {
        static void Main(string[] args)
        {
          ...
          Sphere ball = new Sphere(new Vector3(0f,0f,0f),10f);
            ...
            int intersection1 = ball.countIntersection(ray1, distance1);
            ...
            int intersection2 = ball.countIntersection(ray2, distance2);
            ...
            int intersection3 = ball.countIntersection(ray3, distance3);
            ...
            int intersection4 = p.countIntersection(ray2, distance4);
