...
namespace RaytracerPhotonmapping.photonmap
{
	public class PhotonMap
	{
		...
		public PhotonMap()
		{
			...
			bboxMin = new Vector3D(RaytracerPhotonmapping.SceneConstants.HUGE_VALUE);
			bboxMax = new Vector3D(- RaytracerPhotonmapping.SceneConstants.HUGE_VALUE);
